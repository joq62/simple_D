...
%% dns functions 
-export([add/4,delete/3,delete/4,delete/5,
...
delete(ServiceId,IpAddr,Port)->
    gen_server:call(?MODULE,{delete,ServiceId,IpAddr,Port},infinity).
...
handle_call({delete,ServiceId,IpAddr,Port},_From,State) ->
    Reply=rpc:call(node(),dns_lib,delete,[ServiceId,IpAddr,Port]),
    {reply, Reply, State};
